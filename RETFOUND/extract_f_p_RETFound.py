...
def extract (model, data, dataloader, device):
...
def main():
    ...
    out = extract(model, dataset_test, data_loader_test, device)
    os.makedirs(args.output_dir, exist_ok=True)
    save_path = os.path.join(args.output_dir, f"{args.task}_ev+path+pred+emb.npz")
